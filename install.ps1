...
Write-Host "     brain tui                # Interactive setup"
Write-Host "     brain tui opencode       # OpenCode"
Write-Host "     brain tui claude         # Claude Code"
Write-Host "     brain tui cursor         # Cursor"
Write-Host "     brain tui all            # All at once"
Write-Host ""
